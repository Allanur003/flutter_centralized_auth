class AppLocalizations {
  static const Map<String, Map<String, String>> _strings = {
    'en': {
      ...
      'add_from_phone': 'Apps on My Phone',
      'appearance': 'Appearance',
      'edit_app': 'Edit App',
      'save_changes': 'Save Changes',
      'app_name_required': 'App Name *',
      'icon_emoji': 'Icon (emoji)',
      'android_package': 'Android Package',
      'ios_url_scheme': 'iOS URL Scheme',
      'fallback_url': 'Fallback URL',
      'could_not_open': 'Could not open',
      'browse_popular_apps': 'Browse Popular Apps',
      'installed_apps': 'Installed Apps',
      'search_apps': 'Search apps...',
      'loading_apps': 'Loading installed apps...',
      'no_apps_found': 'No apps found',
      'select_to_add': 'Tap an app to add it to your hub',
      'app_added': 'added to your hub',
      'close': 'Close',
    },
    'tk': {
      ...
      'add_from_phone': 'Telefonumdaky Programmalar',
      'appearance': 'Görünüş',
      'edit_app': 'Programmany üýtget',
      'save_changes': 'Üýtgetmeleri sakla',
      'app_name_required': 'Programma ady *',
      'icon_emoji': 'Nyşan (emoji)',
      'android_package': 'Android paketi',
      'ios_url_scheme': 'iOS URL şemasy',
      'fallback_url': 'Ätiýaçlyk URL',
      'could_not_open': 'Açyp bolmady',
      'browse_popular_apps': 'Meşhur programmalara göz at',
      'installed_apps': 'Gurlan programmalar',
      'search_apps': 'Programma gözle...',
      'loading_apps': 'Programmalar ýüklenýär...',
      'no_apps_found': 'Programma tapylmady',
      'select_to_add': 'Goşmak üçin programa bas',
      'app_added': 'hubňyza goşuldy',
      'close': 'Ýap',
    },
    'ru': {
      ...
      'add_from_phone': 'Приложения на моём телефоне',
      'appearance': 'Оформление',
      'edit_app': 'Редактировать приложение',
      'save_changes': 'Сохранить изменения',
      'app_name_required': 'Название приложения *',
      'icon_emoji': 'Иконка (эмодзи)',
      'android_package': 'Android пакет',
      'ios_url_scheme': 'iOS URL схема',
      'fallback_url': 'Резервный URL',
      'could_not_open': 'Не удалось открыть',
      'browse_popular_apps': 'Популярные приложения',
      ...
      'select_to_add': 'Нажмите на приложение чтобы добавить',
      'app_added': 'добавлено в хаб',
      'close': 'Закрыть',
    },
  };
